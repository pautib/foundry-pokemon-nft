...
contract PokemonHelperTest is Test {
    ...
    function testGetPokemonsByTrainer() public {
        vm.startPrank(USER);
        pokemonInterface.mintPokemon(1000, "Gholdengo1", GHOLDENGO_IMG_URL, "good-as-gold", "", 87, 60, 95, 133, 91, 84, 12, 300);
        pokemonInterface.mintPokemon(1000, "Gholdengo2", GHOLDENGO_IMG_URL, "good-as-gold", "", 87, 60, 95, 133, 91, 84, 12, 300);
